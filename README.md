...
web.xml 의 dispatcherServlet 설정 및 contextConfigureLocation 설정<br></br>
    ######:heavy_check_mark: home.jsp의 경로를 찾지못하는 문제발생. Dynamic Project 하나더 생성하고 다시 진행함 (여기부터 다시):heavy_check_mark:<br></br>
    ######:heavy_check_mark: 새로 생성하고, 똑같이 설정하니까 정상적으로 진행됨 :heavy_check_mark:<br></br>
